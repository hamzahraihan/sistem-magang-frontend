  ...
  return (
    <div className="col-span-3 pb-10">
      <div className="flex flex-col gap-4 lg:col-span-2 col-span-3">
        ...
        <p className="text-base font-bold">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates repellendus ipsa neque sit, facere accusamus minus magni ipsum voluptas consequuntur.</p>
      </div>
    </div>
  );
};
