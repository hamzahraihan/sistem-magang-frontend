    ...
    <div className="grid grid-cols-3 gap-5">
      <div className="flex flex-col gap-4 lg:col-span-2 col-span-3">
        ...
        {loading ? (
          ...
          internship.map((item) => (
            <Link to={`/kegiatan-magang/${item.internship_id}`} className="flex border items-center border-gray-200 rounded-xl p-4 hover:bg-primaryColor active:bg-activeColor hover:text-white transition-all" key={item.internship_id}>
