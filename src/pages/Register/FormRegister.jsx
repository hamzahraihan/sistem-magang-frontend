...
const FormRegister = () => {
  ...
  console.log('🚀 ~ FormRegister ~ dosenData:', dosenData);
  ...
  const handleRegister = (e) => {
    e.preventDefault();
    handleRegisterAccount(registerData);
  };
  console.log('🚀 ~ FormRegister ~ registerData:', registerData);
  return (
    <div className="flex flex-col gap-4 items-center">
      ...
      <form className="flex flex-col gap-3 w-full h-full" onSubmit={handleRegister}>
        <div className="grid grid-cols-2 gap-2">
          <div className="flex flex-col">
            ...
            <input
              name="first_name"
              id="first_name"
              className="border border-gray-200 rounded-xl p-3 text-xs"
              type="text"
        ...
        <select id="gender" name="gender" className="text-xs p-3 border border-gray-200 rounded-xl " value={registerData.gender} onChange={(e) => setRegisterData({ ...registerData, [e.target.name]: e.target.value })} required>
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            className="border border-gray-200 rounded-xl p-3 text-xs"
            type="text"
            placeholder="Cont: 5B, 6A..."
            value={registerData.kelas}
            onChange={(e) => setRegisterData({ ...registerData, [e.target.name]: e.target.value })}
            required
          />
        </div>
        ...
        <select id="dosen_id" name="dosen_id" className="text-xs p-3 border border-gray-200 rounded-xl " value={registerData.dosen_id} onChange={(e) => setRegisterData({ ...registerData, [e.target.name]: e.target.value })} required>
        ...
        <div className="mt-auto">
          <PrimaryButton loading={loadingRegister} text={'Register'} />
        </div>
      </form>
    </div>
  );
