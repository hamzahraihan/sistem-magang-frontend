...
const CommentBar = () => {
  return (
    <div className="flex relative ">
      ...
      <input type="text" name="post" id="post" className="w-full ps-16 border-0 focus:ring-0 focus:outline-none rounded-xl p-5 me-3 text-xs ring-0" placeholder="Buat komentar..." required />
